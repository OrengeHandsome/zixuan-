            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-edit"></i> 修改个人资料 <span class="fa fa-chevron-down"></span></a>
                  ...
                  <li><a><i class="fa fa-flag"></i> 发布相关文档 <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                    	<li><a href="${pageContext.request.contextPath}/teacher/uploadTaskBook">发布任务书、指导书</a></li>
						<li><a href="${pageContext.request.contextPath}/teacher/uploadOpening">发布开题报告</a></li>
						<li><a href="${pageContext.request.contextPath}/teacher/uploadKeXingXing">发布外文翻译文档报告</a></li>
						<li><a href="${pageContext.request.contextPath}/teacher/uploadXuQiu">发布校外毕业设计（论文）申请表</a></li>
						<li><a href="${pageContext.request.contextPath}/teacher/uploadGaiYao">发布中期答辩文档报告</a></li>
						<li><a href="${pageContext.request.contextPath}/teacher/uploadShuJuKu">发布相关文档报告</a></li>
                  ...
                  <li><a><i class="fa fa-check-square-o"></i> 审核文档 <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
						...
						<li><a href="${pageContext.request.contextPath}/teacher/checkKexing">审核外文翻译文档报告</a></li>
						<li><a href="${pageContext.request.contextPath}/teacher/checkXuqiu">审核校外毕业设计（论文）申请表</a></li>
						<li><a href="${pageContext.request.contextPath}/teacher/checkGaiyao">审核中期答辩文档报告</a></li>
						<li><a href="${pageContext.request.contextPath}/teacher/checkShujuku">审核相关文档报告</a></li>
